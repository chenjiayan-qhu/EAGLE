...
class BaselineDSLightningModule(pl.LightningModule):
    def __init__(
        self,
        model=None,
        optimizer=None,
    ...
    def validation_step(self, batch, batch_idx: int):
        ...
        gt_pre, est_labels = self(images)
        

        if 'GT_BceDiceLoss' in self.loss_func.__class__.__name__:   
            val_loss = self.loss_func(gt_pre, est_labels, tar_labels)
        else:
